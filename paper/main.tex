...
Table~\ref{tab:graph} reports the consequence. The relation-aware GNN and the
degree control --- the same behavior MLP given only the two full-graph degrees
--- are close, which locates the GNN's advantage in structural bookkeeping
rather than in relational learning that a feature model could not perform.
