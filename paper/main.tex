...
all five business-disjoint folds, at the threshold maximising Macro-F1.}
\label{fig:cm}
\end{figure}
...
The authors thank % TODO: professor's name and title, e.g. Prof. Jane Doe
\textbf{[ADVISOR NAME]} for guidance throughout this project.
